...
- Advanced Diagnostics now opens a fakeable shell summary with active session, loaded/built-in modes, artifact status counts, warning codes, missing artifact count, recent command names, and recent diagnostic events.
