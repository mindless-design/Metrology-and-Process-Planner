...
_MENU_ROWS = (
    ...
    (
        ...
        "mpp_open_session",
        "Open Session...",
        "Open an existing Process Planner session.json document.",
        CommandGroup.SESSION,
    ),
    (
        ...
        "mpp_new_session",
        "New Session...",
        "Create a new Process Planner session.json document.",
        CommandGroup.SESSION,
    ),
    (
    ...
    (
        ...
        "mpp_open_reporting_workbench",
        "Reporting Workbench",
        "Open the modeless report preview and export workbench.",
        CommandGroup.SESSION,
    ),
)
...
_WORKFLOW_ROWS = (
    ...
    (CommandId.DONE, "Done", CommandGroup.MEASUREMENT),
    ...
    (CommandId.SCAN_ARTIFACTS, "Scan Artifacts", CommandGroup.ARTIFACT),
    (
        CommandId.REGENERATE_MISSING_ARTIFACTS,
        "Regenerate Missing Artifacts",
        CommandGroup.ARTIFACT,
    ),
    (
        CommandId.REGENERATE_STALE_ARTIFACTS,
        "Regenerate Stale Artifacts",
        CommandGroup.ARTIFACT,
    ),
    (CommandId.RELINK_ARTIFACT, "Relink Artifact", CommandGroup.ARTIFACT),
    (CommandId.EXPORT_ARTIFACT_MANIFEST, "Export Artifact Manifest", CommandGroup.ARTIFACT),
    ...
    (CommandId.OPEN_RECENT_SESSION, "Open Recent Session", CommandGroup.SESSION),
    (CommandId.SAVE_SESSION, "Save Session", CommandGroup.SESSION),
    (CommandId.SAVE_SESSION_AS, "Save Session As", CommandGroup.SESSION),
    (CommandId.CLOSE_SESSION, "Close Session", CommandGroup.SESSION),
    (CommandId.REVEAL_SESSION_FOLDER, "Reveal Session Folder", CommandGroup.SESSION),
    (CommandId.VALIDATE_SESSION, "Validate Session", CommandGroup.SESSION),
    (CommandId.REPAIR_SESSION, "Repair Session", CommandGroup.SESSION),
    (CommandId.IMPORT_LEGACY_SESSION_FOLDER, "Import Legacy Session Folder", CommandGroup.SESSION),
    (
        CommandId.BIND_CURRENT_LAYOUT_TO_SESSION,
        "Bind Current Layout to Session",
        CommandGroup.SESSION,
    ),
...
_SETUP_ROWS = (
    ...
    (CommandId.START_OPTICAL_ALIGNMENT_CAPTURE, "Start Optical Alignment Capture"),
