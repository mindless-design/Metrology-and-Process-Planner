...
from metrology_process_planner.domains.process.solver_profiles import ConformalProfile, EtchProfile
...
def _map_columns(
    ...
    return StackGeometry2D(tuple(fn(column) for column in geometry.columns))
